...
class Ui_SettingsMenu(object):
    def setupUi(self, SettingsMenu):
        ...
        self.rateLimitLabel = QtWidgets.QLabel(parent=self.groupBox_2)
        self.rateLimitLabel.setObjectName("rateLimitLabel")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.rateLimitLabel)
        self.rateLimitSpinBox = QtWidgets.QDoubleSpinBox(parent=self.groupBox_2)
        self.rateLimitSpinBox.setDecimals(2)
        self.rateLimitSpinBox.setSingleStep(0.05)
        self.rateLimitSpinBox.setObjectName("rateLimitSpinBox")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.rateLimitSpinBox)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.timeoutSpinBox)
        ...
        self.openBtn = QtWidgets.QPushButton(parent=self.groupBox_3)
        self.openBtn.setObjectName("openBtn")
        self.gridLayout_2.addWidget(self.openBtn, 0, 3, 1, 1)
    ...
    def retranslateUi(self, SettingsMenu):
        ...
        self.rateLimitLabel.setText(_translate("SettingsMenu", "Rate Limit"))
        self.rateLimitSpinBox.setSuffix(_translate("SettingsMenu", "s"))
        ...
        self.openBtn.setText(_translate("SettingsMenu", "Open"))
