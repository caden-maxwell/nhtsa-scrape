...
class Ui_ScrapeMenu(object):
    def setupUi(self, ScrapeMenu):
        ...
        self.body.addLayout(self.damageLayout, 2, 0, 1, 1)
        self.line_3 = QtWidgets.QFrame(parent=ScrapeMenu)
        self.line_3.setFrameShape(QtWidgets.QFrame.Shape.VLine)
        self.line_3.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_3.setObjectName("line_3")
        self.body.addWidget(self.line_3, 0, 1, 3, 1)
        ...
        self.body.addLayout(self.vehicleLayout, 0, 0, 1, 1)
        ...
        self.maxDvSpin = QtWidgets.QSpinBox(parent=ScrapeMenu)
        self.maxDvSpin.setMaximum(999999999)
        self.maxDvSpin.setObjectName("maxDvSpin")
        self.deltaLayout.addWidget(self.maxDvSpin, 1, 3, 1, 1)
        self.minDvSpin = QtWidgets.QSpinBox(parent=ScrapeMenu)
        self.minDvSpin.setMaximum(999999999)
        self.minDvSpin.setObjectName("minDvSpin")
        self.deltaLayout.addWidget(self.minDvSpin, 1, 1, 1, 1)
        self.body.addLayout(self.deltaLayout, 2, 2, 1, 1)
        self.line_5 = QtWidgets.QFrame(parent=ScrapeMenu)
        self.line_5.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_5.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_5.setObjectName("line_5")
        self.body.addWidget(self.line_5, 1, 0, 1, 1)
        self.line_4 = QtWidgets.QFrame(parent=ScrapeMenu)
        self.line_4.setFrameShape(QtWidgets.QFrame.Shape.HLine)
        self.line_4.setFrameShadow(QtWidgets.QFrame.Shadow.Sunken)
        self.line_4.setObjectName("line_4")
        self.body.addWidget(self.line_4, 1, 2, 1, 1)
